...
function CheckBrowser() {
 ...
 function validateForm() {
     let x = document.forms["ShoppingList"]["name"].value;
	 if (x == "") {
	 alert("Please enter name of the item!");
	 return false;
   }

     var y = document.forms["ShoppingList"]["data"].value;
     if (y=="") {
     alert("Please enter quantity!");
     return false;
}
	 
	 var y = document.forms["ShoppingList"]["firstname"].value;
     if (y=="") {
     alert("Please enter your first name!");
     return false;
}
	 
	 var y = document.forms["ShoppingList"]["lastname"].value;
     if (y=="") {
     alert("Please enter your last name!");
     return false;
}

     var y = document.forms["ShoppingList"]["email"].value;
     if (y=="") {
     alert("Please enter your email!");
     return false;
}
     
	 var y = document.forms["ShoppingList"]["card"].value;
     if (y=="") {
     alert("Please enter your card number!");
     return false;
}

     var y = document.forms["ShoppingList"]["CVV"].value;
     if (y=="") {
